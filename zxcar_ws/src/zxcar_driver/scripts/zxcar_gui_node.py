...
class CtrlWindow(QWidget):
    ...
    def __init__(self):
        ...
        magnetic_subscriber = rospy.Subscriber("/zxcar/magnetic", MagneticField, self.magnetic_callback)
        ...
        self.servo_publisher = rospy.Publisher("/zxcar/cmd_servo", Float32, queue_size=20)
        ...
        btn_vel_ctrl = QPushButton("发送")
        vel_ctrl_layout.addRow(btn_vel_ctrl)

        btn_vel_ctrl.clicked.connect(self.click_vel_ctrl)
